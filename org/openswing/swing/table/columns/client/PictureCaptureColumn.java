...
import org.openswing.swing.table.editors.client.PictureCaptureCellEditor;
import org.openswing.swing.table.renderers.client.PictureCaptureTableCellRenderer;
 ...
 * @version 1.0
 */
public class PictureCaptureColumn extends Column {
    ...
    public final TableCellRenderer getCellRenderer(GridController tableContainer, Grids grids) {
        return new PictureCaptureTableCellRenderer(
                tableContainer,
                getColumnName(),
                isShowUploadButton(),
    ...
    public final TableCellEditor getCellEditor(GridController tableContainer, Grids grids) {
        return new PictureCaptureCellEditor(
                tableContainer,
                getFileFilter(),
                isShowUploadButton(),
                isShowDownloadButton(),
